...
export default function Dashboard() {
  ...
  return (
    <section>
      ...
      <div className="panel mb-4 flex flex-col items-center justify-between gap-3 rounded p-3 sm:flex-row">
        <div className="flex flex-col items-center gap-3 sm:flex-row">
          <span aria-hidden className="max-w-32 sm:w-16">
            <svg
              fill="#f5e000"
              width="100%"
              height="100%"
          ...
          <div>
            <div className="text-xs font-medium sm:text-sm lg:text-xl">
              ¿Tienes ideas, necesidades o detectaste un error?
            </div>
            <div className="muted text-sm font-bold lg:text-xl">
              <small>Puedes sugerir cualquier cosa y ayudarnos a mejorar.</small>
            </div>
          </div>
        </div>
        <NavLink
          to="/sugerencias"
          className={(isActive) =>
            `flex items-center gap-2 text-sm text-stone-600 ${isActive ? 'active' : ''}`
          }
        >
          <small className="font-extrabold">Enviar</small>
          <Icon className="w-6 min-w-2 sm:w-7 lg:w-8 xl:w-9">
            <SuggestionsIcon />
          </Icon>
        </NavLink>
      </div>
