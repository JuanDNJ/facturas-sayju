    ...
    <section className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex w-full gap-2 sm:w-auto">
          <Link to={`/invoices/${id}`} className="btn btn-secondary w-full text-center sm:w-auto">
            Ver
          </Link>
            ...
            <div className="panel space-y-2 rounded p-4 text-sm">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div>
                  ...
                  />
                  {errors.customerName && (
                    <div className="mt-1 text-xs text-red-600">{errors.customerName}</div>
                  )}
                </div>
                <div>
                  ...
                  {errors.customerTaxId && (
                    <div className="mt-1 text-xs text-red-600">{errors.customerTaxId}</div>
                  )}
                </div>
                <div className="sm:col-span-2">
                  ...
                  {errors.customerAddress && (
                    <div className="mt-1 text-xs text-red-600">{errors.customerAddress}</div>
                  )}
                </div>
                <div>
