type StampVariant = 'pagado' | 'anulado' | 'vencido' | 'borrador' | 'personalizado'
...
export default function Stamp({
  ...
  return (
    <span
      className={`inline-flex items-center justify-center rounded border-2 align-middle leading-none tracking-widest uppercase select-none ${dimensionClasses} ${colorByVariant[variant]} opacity-90/100 ${rotate} overflow-hidden px-3 text-center text-ellipsis whitespace-nowrap ${className}`}
      style={{
