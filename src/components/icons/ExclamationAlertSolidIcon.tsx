...
export function ExclamationAlertSolidIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        d="M12 20.75a8.75 8.75 0 1 0 0-17.5a8.75 8.75 0 0 0 0 17.5M10.639 8.063C10.564 7.24 11.195 6.53 12 6.53s1.436.71 1.361 1.532l-.54 4.538a.83.83 0 0 1-.821.766a.83.83 0 0 1-.82-.766zm2.728 8.039a1.367 1.367 0 1 1-2.734 0a1.367 1.367 0 0 1 2.734 0"
      ></path>
      <path
        fill="currentColor"
