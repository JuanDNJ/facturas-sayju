...
export default function Layout() {
  ...
  const layoutCols = collapsed ? 'md:grid-cols-[4rem_1fr]' : 'md:grid-cols-[16rem_1fr]'
  return (
    <div className={`md:grid md:h-screen md:overflow-hidden ${layoutCols}`}>
      ...
      <div className="grid grid-rows-[auto_1fr] md:min-h-0">
        <Topbar
          ...
          collapsed={collapsed}
        />
        <main className="p-4 pt-2 sm:p-6 md:min-h-0 md:overflow-auto">
          <Outlet />
        </main>
      </div>
    </div>
